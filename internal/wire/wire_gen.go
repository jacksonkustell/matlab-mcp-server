...
func Initialize(serverDefinition ApplicationDefinition) *Application {
	...
	syntheticHeartbeatProgressUpdateSource := runmatlabbuildfile.NewSyntheticHeartbeatProgressUpdateSource()
	progressMonitor := runmatlabbuildfile.NewProgressMonitor(syntheticHeartbeatProgressUpdateSource)
	runmatlabbuildTool := runmatlabbuild.New(loggerFactory, telemetryFactory, runmatlabbuildfileUsecase, globalMATLAB, progressMonitor)
